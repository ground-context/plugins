...
public class PluginUtil {
  ...
  static {
    ...
    groundServerAddress =
        properties.getProperty("edu.berkeley.ground.server.address", DEFAULT_ADDRESS);
  }
  ...
  public static List<Long> getLatestVersions(String name, String type)
  ...
  public static StringRequestEntity createRequestEntity(String jsonRecord)
    ...
    StringRequestEntity requestEntity =
        new StringRequestEntity(jsonRecord, "application/json", "UTF-8");
