...
public class GroundReadWriteStructureResource {
    ...
    static final private Logger logger = LoggerFactory.getLogger(GroundReadWriteStructureResource.class.getName());
    ...
    public StructureVersion getStructureVersion(String entityType, String state) throws GroundException {
