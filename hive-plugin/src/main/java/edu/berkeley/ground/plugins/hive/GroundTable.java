...
public class GroundTable {
    ...
    NodeVersion createTableNodeVersion(Table table) throws InvalidObjectException, MetaException {
        ...
        try {
            ...
            StructureVersion sv = groundReadWrite.getGroundReadWriteStructureResource().getStructureVersion(TABLE,
    ...
    Partition getPartition(String dbName, String tableName, String partName)
        ...
        try {
            ...
            logger.error("Unable to find partition {} for table {} in database {}", partName, tableName, dbName);
            throw new MetaException(ex.getMessage());
        }
    }
